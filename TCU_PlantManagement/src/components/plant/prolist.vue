                        ...
                        >
                            ...
                            <tbody>
                                <tr class="gradeX" v-for="(item,index) in showItems" :key="index">
                                    ...
                                    <td class="actions" >
                                        <a @click="editItem(item)" data-toggle="modal" data-target="#delete">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" v-model="createItem.admin">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">名称</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" v-model="createItem.title">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">内容</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" v-model="createItem.detail">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">负责人</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" v-model="item.admin">
                                            </div>
                                        </div>
                                        <div class="form-group">
...
export default {
    ...
    methods: {
        ...
        // 初始化数据
        async init(){
            let lists = await apis.protect.findAndCountAll(this.off, this.PageShowSum)
        ...
        // 创建初始化
        docreate(){ this.createItem = { condition: 0 } },
        // 创建元素
        async toCreat(){
        ...
        // 获取编辑元素
        editItem(item){ console.log(item);this.item = JSON.parse(JSON.stringify(item)); },
        // 执行编辑
        async toEdit(){
